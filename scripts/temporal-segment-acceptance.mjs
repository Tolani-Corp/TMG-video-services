...
const PARENT_MANIFEST = "/tmp/tmg-temporal-parent-manifest.json";
const PARENT_RIGHTS = "/tmp/tmg-temporal-parent-rights.json";
const PARENT_CURRENT = "/tmp/tmg-temporal-parent-current-rights.json";
